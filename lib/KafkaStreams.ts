...
class KafkaStreams extends EventEmitter {
    ...
    storageClass: new (options?: object) => KStorage
    kafkaClients: any[]
    storages: any[]
     ...
     */
    constructor(config: KafkaStreamsConfig, storageClass: new (options?: object) => KStorage, storageOptions: object = {}, disableStorageTest: boolean = false) {
        super();
        ...
        this.storageClass = storageClass || new KStorage;
    ...
    static checkStorageClass(storageClass: new (options?: object) => KStorage) {
     ...
     * @returns {KStream}
     */
    getKStream(topic: string, storage = null) {
